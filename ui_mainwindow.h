...
""));
        ...
        nextPage_3->setGeometry(QRect(1100, 240, 81, 71));
...
"}"));
        ...
        michigan_campus->setGeometry(QRect(100, 78, 501, 401));
...
"}"));
        ...
        ucla_title->setGeometry(QRect(300, 11, 731, 35));
...
"}"));
        ...
        purchase_button->setStyleSheet(QLatin1String("QPushButton {\n"
"	background: darkblue;\n"
"	color: white;\n"
"	border-style: outset;\n"
"	border-radius: 20px;\n"
...
"}"));
        ...
        search_edit->setStyleSheet(QLatin1String("QLineEdit {\n"
"	border-style: inset;\n"
"	border-radius: 5px;\n"
"}"));
...
"}"));
        ...
        display_comboBox->setStyleSheet(QStringLiteral(""));
        ...
        tour_button->setStyleSheet(QLatin1String("QPushButton {\n"
"	background: darkblue;\n"
"	color: white;\n"
"	border-style: outset;\n"
"	border-radius: 20px;\n"
...
"}"));
        ...
        backPage_14->setGeometry(QRect(0, 240, 81, 70));
...
"}"));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        ucla_title->setText(QApplication::translate("MainWindow", "University of California, Los Angeles (UCLA)", 0));
        ...
        purchase_button->setText(QApplication::translate("MainWindow", "Online Purchasing", 0));
