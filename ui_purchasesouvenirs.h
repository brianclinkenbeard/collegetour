...
public:
    ...
    void setupUi(QDialog *purchaseSouvenirs)
    {
        ...
        purchaseSouvenirs->resize(638, 519);
...
"}"));
        ...
        label->setGeometry(QRect(230, 10, 261, 51));
        QFont font;
        label->setFont(font);
        ...
        lineEdit_quanity->setStyleSheet(QLatin1String("QLineEdit {\n"
"	border-style: inset;\n"
"	border-radius: 2px;\n"
"}"));
...
"}\n"
""));
        tableWidget_receipt->setHorizontalScrollBarPolicy(Qt::ScrollBarAlwaysOff);
        ...
        tableWidget_total->setStyleSheet(QLatin1String("QTableWidget {\n"
"	border-style: outset;\n"
"	border-radius: 5px;\n"
"}"));
        label->raise();
    ...
    void retranslateUi(QDialog *purchaseSouvenirs)
    {
        ...
        label->setText(QApplication::translate("purchaseSouvenirs", "Purchase Souvenirs Online", 0));
